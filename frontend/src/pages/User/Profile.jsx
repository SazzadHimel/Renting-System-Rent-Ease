...
import { useProfileMutation, useGetUserDetailsQuery } from "../../redux/api/usersApiSlice";
...
const Profile = () => {
  ...
  const { data: userDetails, isLoading, isError } = useGetUserDetailsQuery(userInfo._id);
  ...
  useEffect(() => {
    if (userDetails) {
      ...
      setProfilePicture(userDetails.profilePicture); // Update profile picture state
      setIsMerchant(userDetails.isMerchant);
    }
  }, [userDetails]);
    ...
    <div className="container pt-40 px-40 pb-20 bg-gray-800 text-white shadow-lg">
      <div className="flex flex-col md:flex-row justify-center items-center md:space-x-4">
        <div className="md:w-1/3 flex flex-col items-center">
          ...
          <div className="p-10">
            <span className="block mb-2 font-semibold text-3xl">This is a {isMerchant ? "Merchant" : "User Profile"}</span>
          </div>
        </div>
